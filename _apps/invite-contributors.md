...
**invite-contributors** is a GitHub App built with [octotask](https://github.com/octotask/octotask) that automatically invites new contributors to your repository's organization once they get a Pull Request merged.
